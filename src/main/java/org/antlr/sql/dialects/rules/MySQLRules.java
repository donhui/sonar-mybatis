...
public enum MySQLRules {
	...
	protected Rule getSelectAllRule() {
		...
		impl.getNames().getTextItem().add(TSqlParser.Select_list_elemContext.class.getSimpleName());
		...
		child.getNames().getTextItem().add(TSqlParser.AsteriskContext.class.getSimpleName());
