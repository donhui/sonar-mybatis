...
import org.sonarsource.plugins.mybatis.issues.RuleToCheck.CandidateCheck;
    ...
    public List<RuleToCheck.RuleCheckResult2> search(Map<RuleToCheck, RuleToCheck.RuleCheckResult> rulesToCheck) {
        ...
        for (RuleToCheck rule : rulesToCheck.keySet()) {
            ...
            if (candidates.candidates.isEmpty()) {
                org.sonarsource.plugins.mybatis.issues.RuleToCheck.RuleNodesMap map = new org.sonarsource.plugins.mybatis.issues.RuleToCheck.RuleNodesMap(
                        rule.rule);
