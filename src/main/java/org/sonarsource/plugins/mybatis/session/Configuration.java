 ...
 */
package org.sonarsource.plugins.mybatis.session;
...
import org.sonarsource.plugins.mybatis.binding.MapperRegistry;
import org.sonarsource.plugins.mybatis.builder.CacheRefResolver;
import org.sonarsource.plugins.mybatis.builder.xml.XMLStatementBuilder;
import org.sonarsource.plugins.mybatis.executor.*;
import org.sonarsource.plugins.mybatis.executor.keygen.KeyGenerator;
import org.sonarsource.plugins.mybatis.executor.loader.ProxyFactory;
import org.sonarsource.plugins.mybatis.executor.loader.cglib.CglibProxyFactory;
...
import org.sonarsource.plugins.mybatis.executor.statement.RoutingStatementHandler;
...
import org.sonarsource.plugins.mybatis.scripting.LanguageDriverRegistry;
import org.sonarsource.plugins.mybatis.scripting.defaults.RawLanguageDriver;
...
public class Configuration {
  ...
  protected org.apache.ibatis.session.LocalCacheScope localCacheScope = org.apache.ibatis.session.LocalCacheScope.SESSION;
  protected JdbcType jdbcTypeForNull = JdbcType.OTHER;
  protected Set<String> lazyLoadTriggerMethods = new HashSet<>(Arrays.asList("equals", "clone", "hashCode", "toString"));
  protected Integer defaultStatementTimeout;
  protected Integer defaultFetchSize;
  protected ResultSetType defaultResultSetType;
  protected org.apache.ibatis.session.ExecutorType defaultExecutorType = org.apache.ibatis.session.ExecutorType.SIMPLE;
  protected org.apache.ibatis.session.AutoMappingBehavior autoMappingBehavior = org.apache.ibatis.session.AutoMappingBehavior.PARTIAL;
  protected org.apache.ibatis.session.AutoMappingUnknownColumnBehavior autoMappingUnknownColumnBehavior = org.apache.ibatis.session.AutoMappingUnknownColumnBehavior.NONE;
  ...
  /**
   * Gets an applying type when omit a type on sql provider annotation(e.g. {@link org.sonarsource.plugins.mybatis.annotations.SelectProvider}).
   *
  ...
  /**
   * Sets an applying type when omit a type on sql provider annotation(e.g. {@link org.sonarsource.plugins.mybatis.annotations.SelectProvider}).
   *
  ...
  public Executor newExecutor(Transaction transaction, org.apache.ibatis.session.ExecutorType executorType) {
    executorType = executorType == null ? defaultExecutorType : executorType;
    Executor executor;
    if (org.apache.ibatis.session.ExecutorType.BATCH == executorType) {
