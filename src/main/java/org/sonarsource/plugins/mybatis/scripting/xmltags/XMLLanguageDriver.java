...
import org.sonarsource.plugins.mybatis.builder.xml.XMLMapperEntityResolver;
...
import org.sonarsource.plugins.mybatis.scripting.defaults.DefaultParameterHandler;
...
public class XMLLanguageDriver implements LanguageDriver {
  ...
  public SqlSource createSqlSource(Configuration configuration, XNode script, Class<?> parameterType) {
    org.sonarsource.plugins.mybatis.scripting.xmltags.XMLScriptBuilder builder = new XMLScriptBuilder(configuration, script, parameterType);
  ...
  public SqlSource createSqlSource(Configuration configuration, String script, Class<?> parameterType) {
    ...
    if (script.startsWith("<script>")) {
      ...
      org.sonarsource.plugins.mybatis.scripting.xmltags.TextSqlNode textSqlNode = new TextSqlNode(script);
