 ...
 */
package org.sonarsource.plugins.mybatis.executor.loader;
...
public abstract class AbstractSerialStateHolder implements Externalizable {
  ...
  private Map<String, org.sonarsource.plugins.mybatis.executor.loader.ResultLoaderMap.LoadPair> unloadedProperties;
  ...
  public AbstractSerialStateHolder(
          ...
          final Map<String, org.sonarsource.plugins.mybatis.executor.loader.ResultLoaderMap.LoadPair> unloadedProperties,
  ...
  protected final Object readResolve() throws ObjectStreamException {
    ...
    try (ObjectInputStream in = new ObjectInputStream(new ByteArrayInputStream(this.userBeanBytes))) {
      ...
      this.unloadedProperties = (Map<String, org.sonarsource.plugins.mybatis.executor.loader.ResultLoaderMap.LoadPair>) in.readObject();
    ...
    final Map<String, org.sonarsource.plugins.mybatis.executor.loader.ResultLoaderMap.LoadPair> arrayProps = new HashMap<>(this.unloadedProperties);
